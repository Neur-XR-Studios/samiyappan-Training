...
namespace UnityStandardAssets.CrossPlatformInput
{
    public abstract class VirtualInput
    {
        ...
        protected List<string> m_AlwaysUseVirtual = new List<string>();
            // list of the axis and Pickupbutton names that have been flagged to always use a virtual axis or Pickupbutton
        ...
        {
            // if we have a Pickupbutton with this name then remove it from our dictionary of registered buttons
