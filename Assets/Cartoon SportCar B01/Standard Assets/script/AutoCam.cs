...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_TurnSpeed = 1; // How fast the rig will turn to keep up with target's rotation_blade
        ...
        [SerializeField] private float m_SpinTurnLimit = 90;// The threshold beyond which the camera stops following the target's rotation_blade. (used in situations where a car spins out, for example)
        ...
        [SerializeField] private float m_SmoothTurnTime = 0.2f; // the smoothing for the camera's rotation_blade
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            {
                // in follow velocity mode, the camera's rotation_blade is aligned towards the object's velocity direction
            ...
            {
                // we're in 'follow rotation_blade' mode, where the camera rig's rotation_blade follows the object's rotation_blade.

                // This section allows the camera to stop following the target's rotation_blade when the target is spinning too fast.
                // eg when a car has been knocked into a spin. The camera will resume following the rotation_blade
            ...
            // camera's rotation_blade is split into two parts, which can have independend speed settings:
